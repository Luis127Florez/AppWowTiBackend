...
exports.DeleteCompras = exports.GetDetalleCompraById = exports.GetCompras = void 0;
...
const GetCompras = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const compras = yield comprasModel_1.default.findAll({ where: {
                estado: true
            }, include: [{ model: usersModel_1.default }] });
        res.json(compras);
    }
    catch (error) {
        console.log(error);
...
const DeleteCompras = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const compras = yield comprasModel_1.default.findByPk(id);
        if (!compras)
            return res.json({ msg: "no se encontro una compra con ese id" });
        compras.update({
            estado: false
        });
        res.json(compras);
...
exports.DeleteCompras = DeleteCompras;
